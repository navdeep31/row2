...
public class TestData {
	...
	private void setupData() {
		...
		products.add(new Product(7l,7l,"Rose Bush","Roses are red...", 0, 1599, 1499, ProductStatus.AVALIABLE, LocalDate.of(2016, Month.DECEMBER, 7), "Plants", "images/products/rose-bush.jpg"));
		products.add(new Product(8l,8l,"20x Violets","Violets are blue...", 5, 1799, 1299, ProductStatus.ON_HOLD, LocalDate.of(2016, Month.DECEMBER, 7), "Plants", "images/products/violets.jpg"));
		products.add(new Product(9l,9l,"10x Fuchsia","I can see into the fuchsia", 15, 1999, 1699, ProductStatus.AVALIABLE, LocalDate.of(2016, Month.DECEMBER, 7), "Plants", "images/products/fuschia.jpg"));
		products.add(new Product(10l,10l,"Pitchfork","Get your torches and pitchforks!", 6, 2499, 1999, ProductStatus.AVALIABLE, LocalDate.of(2016, Month.DECEMBER, 7), "Equipment", "images/products/pitchfork.png"));
		products.add(new Product(11l,11l,"Garden Trowel","Dig a hole in the ground", 0, 1399, 1099, ProductStatus.ON_HOLD, LocalDate.of(2016, Month.DECEMBER, 7), "Equipment", "images/products/trowel.jpg"));
		products.add(new Product(12l,12l,"Rake","Want to leave leaving leaves left around left in the past? Then get this rake!", 12, 1199, 999, ProductStatus.AVALIABLE, LocalDate.of(2016, Month.DECEMBER, 7), "Equipment", "images/products/rake.jpg"));
		products.add(new Product(13l,13l,"Garden Gloves","Trouble with thorns? Not any more with these elegant gardening gloves made of cutting edge protective material", 6, 1499, 1499, ProductStatus.AVALIABLE, LocalDate.of(2016, Month.DECEMBER, 7), "Equipment", "garden-gloves"));
